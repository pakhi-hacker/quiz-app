let userName;
let qstnSlDisplay = document.querySelector('#qstn-sl-count');//This variable is to define question serial number.
...
let correctAnswer;// Above are question and answer variables
...
let totalTimeTaken = 0;//Above are variables...
...
//Above code is to clear time interval
